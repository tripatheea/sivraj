...
recognition.onresult = function(event) {
  ...
  if (((interim_transcript.toLowerCase().trim() == 'jarvis') || (interim_transcript.toLowerCase().trim() == 'sam') || (interim_transcript.toLowerCase().trim() == 'eva'))  && ( ! jarvis_start_sound_played)) {
  ...
  if ( ! ((final_transcript.toLowerCase().trim() == 'jarvis') || (final_transcript.toLowerCase().trim() == 'sam') || (final_transcript.toLowerCase().trim() == 'eva'))) {
    final_transcript = '';
  }
